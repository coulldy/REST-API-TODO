...
func (h *HTTPHandlers) HandleCreateTask(w http.ResponseWriter, r *http.Request) {
	...
	if err := h.todoList.AddTask(todoTask); err != nil {
		...
		if errors.Is(err, todo.ErrTaskAlereadyExists) {
...
func (h *HTTPHandlers) HandleGetTask(w http.ResponseWriter, r *http.Request) {
	titile := mux.Vars(r)["titile"]
	task, err := h.todoList.GetTask(titile)
	if err != nil {
		errDTO := ErrorDTO{
			Message: err.Error(),
			Time:    time.Now(),
...
func (h *HTTPHandlers) HandlGeteAllTask(w http.ResponseWriter, r *http.Request) {
...
failed:
  ...
  - response body: JSON with error + time
*/
func (h *HTTPHandlers) HandlGeteAllUncompletedTasks(w http.ResponseWriter, r *http.Request) {
...
func (h *HTTPHandlers) HandlDeleteTask(w http.ResponseWriter, r *http.Request) {
	title := mux.Vars(r)["title"]
